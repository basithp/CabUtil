 ...
 */
public class LoginActivity extends AppCompatActivity implements APIFetcher.APIAuthenticationCallback {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            APIFetcher.authenticateUserforLogin(email,password, this);
        }
    }
